...
if TYPE_CHECKING:
    from nets.escaip.configs import (
        GlobalConfigs,
        GraphNeuralNetworksConfigs,
        MolecularGraphConfigs,
        RegularizationConfigs,
    )
    from nets.escaip.custom_types import GraphAttentionData
from nets.escaip.modules.base_block import BaseGraphNeuralNetworkLayer
from nets.escaip.utils.nn_utils import (
    Activation,
    NormalizationType,
    get_feedforward,
    get_linear,
...
from nets.escaip.utils.stochastic_depth import (
    SkipStochasticDepth,
    StochasticDepth,
)
